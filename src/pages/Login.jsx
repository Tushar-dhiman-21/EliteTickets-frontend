  ...
  return (
    <div className="max-w-md mx-auto mt-20 bg-white p-8 rounded-xl shadow-lg border border-gray-100">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500">Sign in to your EliteTickets account</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {!showOTP ? (
          <>
            ...
            <Link to="/forgot-password" className="text-sm text-gray-700 hover:text-black font-medium hover:underline">
              Forgot Password?
            </Link>
          </div>
